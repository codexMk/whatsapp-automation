    ...
    <PageContainer>
      ...
      <div className="mb-8 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-6 shadow-lg border border-slate-700">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-white mb-1">➕ Create New Template</h1>
            <p className="text-slate-300 text-sm">Build a professional template for your campaigns</p>
          </div>
          <button
              ...
              <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-sm font-bold text-blue-900">
                    {formData.name || '(Your template name)'}
                  </p>
                </div>
              </div>
